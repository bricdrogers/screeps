...
function evaluateRequestParts(site: ConstructionSite): BodyPartConstant[] {
  // After some testing, this patten seems pretty optimal
  var partPattern: BodyPartConstant[] = [CARRY, MOVE, WORK, MOVE, CARRY];
  var currentParts: BodyPartConstant[] = [WORK, MOVE, CARRY];
  ...
  while (site.progressTotal - buildEnergyPerLifespan > 0) {
    var part: BodyPartConstant = partPattern[patternIndex];
